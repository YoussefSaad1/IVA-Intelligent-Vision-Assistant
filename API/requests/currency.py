...
URL = "http://127.0.0.1:5000/currency"

f = open('currency_test.jpg', 'rb').read()
...
with open('currency_output.txt', 'w', encoding='utf-8') as nf:
    nf.write(data['text'])
...
if len(sound) > 30: 
    ...
    with open('currency_output.mp3', 'wb') as nf:
        nf.write(sound)
